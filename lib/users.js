...
export async function registerUser(userData) {
  ...
  if (!validateInput(username, 'username')) { // Validate username format
    ...
    throw new ValidationError('Invalid username format. Use 1-50 characters.');
  }
  ...
  if (!validateInput(password, 'password')) {
    ...
    throw new ValidationError('Password is too weak (at least 8 chars, incl. upper, lower, digit).');
  }
