...
// 计算总赞数 (业务层调用utils)
async function computeCommentTreeTotalLikes(postId, commentId) {
...
// 更新祖先总赞数
async function updateCommentAncestorsTotalLikes(postId, initialCommentId) {
...
// API handler
export default async function commentApiHandler(req, res) {
  setCORS(res, req);
